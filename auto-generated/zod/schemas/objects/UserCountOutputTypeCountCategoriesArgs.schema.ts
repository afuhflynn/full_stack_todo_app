...
export const UserCountOutputTypeCountCategoriesArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountCategoriesArgsObjectZodSchema = makeSchema();
